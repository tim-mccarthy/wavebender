...
def main():
    ...
    parser.add_argument('-w', '--wave', help="The type of wave.", default='sine', type=str)
    ...
    if args.wave == 'sine':
        ...
        print("Unknown wave type: {}".format(args.wave))
        return

    # each channel is defined by infinite functions which are added to produce a sample.
    channels = ((wave(args.frequency, args.rate, args.amplitude),) for i in range(args.channels))
